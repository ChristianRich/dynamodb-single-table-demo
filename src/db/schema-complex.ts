...
const Match = {
  ulid: /^[0123456789ABCDEFGHJKMNPQRSTVWXYZ]{26}$/, // Universally Unique Lexicographically Sortable Identifier (not to be confused with UUID)
  email:
  ...
  models: {
    ...
    User: {
      ...
      email: {
        ...
        crypt: false, // !! This requires additional setup
      },
      role: { type: String, default: 'user', enum: ['admin', 'mod', 'user'] },
      address: {
        type: Object,
        default: {},
        schema: {
